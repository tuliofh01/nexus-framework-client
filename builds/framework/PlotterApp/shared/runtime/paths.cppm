//==============================================================================
// nexus.shared.paths — Runtime Path Resolution (C++20 Module)
//
// ════════════════════════════════════════════════════════════════════════════
...
//
// This is a self-contained .cppm with NO separate .cpp implementation file.
// All implementations are inline in the struct definition.
//==============================================================================
...
// ═══════════════════════════════════════════════════════════════════════════
// nxs::runtime — Path Resolution
// ═══════════════════════════════════════════════════════════════════════════

namespace nxs::runtime {

export struct Paths {
    /// Returns the current working directory — typically where the executable
    /// lives. On desktop, this is the directory you run the app from.
