...
import com.nexus.framework.core.model.LangflowEdge
import com.nexus.framework.core.model.LangflowExport
import com.nexus.framework.core.model.LangflowJson
import com.nexus.framework.core.model.LangflowMapping
import com.nexus.framework.core.model.LangflowNode
...
class LangflowTransformationEngine(
    ...
    companion object {
         ...
         * Outputs (ChatOutput / TextOutput) are normal steps — see [inferTarget].
         */
        private val TRIGGER_TYPES = setOf(
            "ChatInput", "TextInput", "Webhook", "Schedule", "Timer",
        )
