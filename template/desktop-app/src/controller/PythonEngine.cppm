...
auto PythonEngine::evaluate(std::string_view functionName,
    ...
    try {
        ...
        // std::memcpy: byte-level copy from numpy's internal buffer to
        // our vector's buffer. Fastest possible transfer — no element-by-
        // element copying. Safe because both are contiguous double arrays.
