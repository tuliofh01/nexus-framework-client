//==============================================================================
// nxs.android.python — Chaquopy/Zig JNI Python Facade (C++20 Module)
//
// ════════════════════════════════════════════════════════════════════════════
// WHAT THIS MODULE DOES
// ════════════════════════════════════════════════════════════════════════════
//
// Singleton facade over Chaquopy via the Zig JNI PythonBridge. C++ never
...
// ── JNI bridge headers (not exported to importers) ──
//
...
// In the JNI bridge header it's nxs::bridge::PythonBridge. We alias
...
public:
    ...
    /// Set the Chaquopy/Zig JNI bridge.
    ///
...
// ═══════════════════════════════════════════════════════════════════════════
// AppCore JNI export (wires the Chaquopy bridge)
// ═══════════════════════════════════════════════════════════════════════════
//
// This function is called by the Zig JNI glue when the Kotlin
