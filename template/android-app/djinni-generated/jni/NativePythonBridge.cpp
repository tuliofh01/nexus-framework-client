...
std::string NativePythonBridge::greeting(const std::string& name) {
    ...
    auto jResult = static_cast<jstring>(env->CallObjectMethod(m_kotlinBridge, m_greeting, jName));
...
Java_com_nexus_{{packageName}}_AppCore_installPythonBridge(JNIEnv* env, jclass, jobject bridge) {
