...
| [`docs/`](../../docs/) | 文档中心 → [docs/hub.md](../../docs/hub.md) |
...
**5. 阅读文档** — [docs/hub.md](../../docs/hub.md) · [coding-with-nexus](../../docs/guides/coding-with-nexus.md) · [generation-pipeline](../../docs/guides/generation-pipeline.md)
...
输出：`builds/framework/<名称>/` · 布局：[builds/LAYOUT.md](../../builds/LAYOUT.md) · [template/README.md](../../template/README.md)
