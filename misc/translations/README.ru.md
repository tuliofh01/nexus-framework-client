...
| [`docs/`](../../docs/) | Хаб документации → [docs/hub.md](../../docs/hub.md) |
...
**5. Читайте docs** — [docs/hub.md](../../docs/hub.md) · [coding-with-nexus](../../docs/guides/coding-with-nexus.md) · [generation-pipeline](../../docs/guides/generation-pipeline.md)
...
Output: `builds/framework/<имя>/` · Layout: [builds/LAYOUT.md](../../builds/LAYOUT.md) · [template/README.md](../../template/README.md)
